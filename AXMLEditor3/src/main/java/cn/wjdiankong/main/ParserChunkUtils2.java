...
//
//public class ParserChunkUtilsHelper.get(fileName)2 {
//
...
//		clear();
//		ParserChunkUtilsHelper.get(fileName).parserXmlHeader(xmlStruct.byteSrc);
//		ParserChunkUtilsHelper.get(fileName).parserStringChunk(xmlStruct.byteSrc);
//		ParserChunkUtilsHelper.get(fileName).parserResourceChunk(xmlStruct.byteSrc);
//		ParserChunkUtilsHelper.get(fileName).parserXmlContent(xmlStruct.byteSrc);
//	}
//
//	/**
//	 * 解析xml的头部信息
