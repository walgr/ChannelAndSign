 ...
 * 支持平台
 */
enum class MarketType(val channelName: String, val url: String, val market: Market = UnknownMarket()) {
    ...
    小米("Xiaomi", "https://dev.mi.com/distribute", XiaomiMarket()),
    华为("Huawei", "https://id1.cloud.huawei.com/AMW/portal/home.html", HuaweiMarket()),
    Oppo("Oppo", "https://open.oppomobile.com/new/loginForHeyTap?location=https%3A%2F%2Fopen.oppomobile.com%2F"),
    Vivo("Vivo", "https://id.vivo.com.cn/#/user/login", VivoMarket()),
